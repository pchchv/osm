...
func TestRelation(t *testing.T) {
	...
	for _, id := range ids {
		...
		if err := Relations(context.Background(), relations, ds, Threshold(30*time.Minute)); err != nil {
...
func TestRelation_reverse(t *testing.T) {
	...
	t.Run("segment reverse", func(t *testing.T) {
		...
		if err != nil {
			t.Fatalf("annotation error: %e", err)
		}
...
func TestRelation_polygon(t *testing.T) {
	...
	expected := []geo.Orientation{geo.CCW, geo.CW, geo.CCW, geo.CW}
...
func TestRelation_circular(t *testing.T) {
	...
	rs := ds.Relations[1]
	if err := Relations(context.Background(), rs, ds, Threshold(30*time.Minute)); err != nil {
